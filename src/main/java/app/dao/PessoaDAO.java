...
public interface PessoaDAO extends JpaRepository<Pessoa, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM Pessoa entity WHERE entity.user.id = :id")
  public Page<Pessoa> findPessoasByUser(@Param(value="id") java.lang.String id, Pageable pageable);
