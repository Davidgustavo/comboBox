	...
	public static Var selectPais() throws Exception {
		return new Callable<Var>() {
			...
			public Var call() throws Exception {
				...
				cronapi.util.Operations.callClientFunction(Var.valueOf("cronapi.screen.notify"), Var.valueOf("success"),
						item);
				combo1 = cronapi.database.Operations.query(Var.valueOf("app.entity.Estado"),
						Var.valueOf("select e from Estado e where e.pais.nome = :paisNome"),
						Var.valueOf("paisNome", item));
